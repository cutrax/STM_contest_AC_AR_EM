/**FILE MODIFICATO IN VARI PUNTI PER LA CORRETTA FREQ DI CLOCK (***)
  ******************************************************************************
  ...
  *-----------------------------------------------------------------------------
  *        System Clock source                    | PLL (HSE Byp) ***
  *-----------------------------------------------------------------------------
  *        SYSCLK(Hz)                             | 84000000 ***
  *-----------------------------------------------------------------------------
  *        HCLK(Hz)                               | 84000000
...
/******************************************************************************/
  ...
  /* Abilita il Bypass di HSE oscillator *** */
  ...
  {
	/* In questo chip non viene usata la modalità 1, vi è un errore!!!!!!!!!! *** */
	  //Inoltre la massima frequenza per la cpu è di 84 MHz ***
    /* Select regulator voltage output Scale 1 mode, System frequency up to 168 MHz */
    RCC->APB1ENR |= RCC_APB1ENR_PWREN;
    PWR->CR |= PWR_CR_VOS_1; //Setta l'MSB di VOS(10=Mode2) ***
