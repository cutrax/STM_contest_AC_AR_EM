                                    ...
                                    uint16_t *end_handle)
{
  ...
  for (i=0; i<bloodPressureCollectorContext.numpeerServices; i++) {
    if (bloodPressureCollectorContext.peerServices[j] == UUID_TYPE_16) {
      Osal_MemCpy(&uuid, &bloodPressureCollectorContext.peerServices[j+5], 2);
      j++;
      Osal_MemCpy(start_handle, &bloodPressureCollectorContext.peerServices[j], 2);
      j += 2;
      Osal_MemCpy(end_handle, &bloodPressureCollectorContext.peerServices[j], 2);
      j += 2;
...
tBleStatus BPC_Init(bpcInitDevType param)
{
  ...
  Osal_MemCpy(&bloodPressureCollectorContext, 0, sizeof(bloodPressureCollectorContext_Type));//TBR
  Osal_MemCpy(bloodPressureCollectorContext.public_addr, param.public_addr, 6);
...
void BPC_BP_Measurement_Indication_CB(uint16_t attr_handle, uint8_t data_length, uint8_t * value)
{
  ...
  if (attr_handle == bloodPressureCollectorContext.BPMeasurementCharValHandle)
  {
    ...
    Osal_MemSet(&BPMeasurement, 0 , sizeof(tBPMValue)); 
    ...
    */
    ...
    Osal_MemCpy(&bloodPressureCollectorContext.BPMeasurementValue, &BPMeasurement, sizeof(BPMeasurement));
...
void BPC_ICP_Notification_CB(uint16_t attr_handle, uint8_t data_length,uint8_t * value)
{
  ...
  if (attr_handle == bloodPressureCollectorContext.ICPCharValHandle)
  {
    ...
    Osal_MemSet(&ICPValue, 0 , sizeof(tICPValue)); 
    ...
    */
    ...
    Osal_MemCpy(&bloodPressureCollectorContext.ICPValue, &ICPValue, sizeof(ICPValue));
  }
