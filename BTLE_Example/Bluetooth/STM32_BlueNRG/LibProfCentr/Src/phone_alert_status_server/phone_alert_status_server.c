...
tBleStatus PASS_Init(passInitDevType param)
{
  ...
  Osal_MemCpy(&phone_alert_status_server_context, 0, sizeof(PhoneAlertStatusServerContext_Type));//TBR
  ...
  Osal_MemCpy(phone_alert_status_server_context.public_addr, param.public_addr, 6);
