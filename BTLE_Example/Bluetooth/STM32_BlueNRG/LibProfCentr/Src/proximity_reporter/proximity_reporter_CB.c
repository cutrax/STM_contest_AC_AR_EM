...
*
*   FILENAME        -  proximity_reporter_CB.c
*
*******************************************************************************
*
*   CHANGE HISTORY
...
*   Comments:    proximity reporter callbacks for profile device, services, 
...
*  File Description 
*  ---------------------
*  Source code for the  proximity reporter callbacks handler (profile central role)
* 
******************************************************************************/
