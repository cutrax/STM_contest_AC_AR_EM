                                    ...
                                    uint16_t *end_handle)
{
  ...
  for (i=0; i<healthThermometerCollectorContext.numpeerServices; i++) {
    if (healthThermometerCollectorContext.peerServices[j] == UUID_TYPE_16) {
      Osal_MemCpy(&uuid, &healthThermometerCollectorContext.peerServices[j+5], 2);
      j++;
      Osal_MemCpy(start_handle, &healthThermometerCollectorContext.peerServices[j], 2);
      j += 2;
      Osal_MemCpy(end_handle, &healthThermometerCollectorContext.peerServices[j], 2);
      j += 2;
...
tBleStatus HT_Collector_Init(htcInitDevType param)
{
  ...
  Osal_MemCpy(&healthThermometerCollectorContext, 0, sizeof(healthThermometerCollectorContext_Type));//TBR
  Osal_MemCpy(healthThermometerCollectorContext.public_addr, param.public_addr, 6);
...
void HT_Collector_Temperature_Measurement_Indication_CB(uint16_t attr_handle, uint8_t data_length,uint8_t * value)
{
  ...
  if (attr_handle == healthThermometerCollectorContext.TempMeasurementCharValHandle)
  {
    ...
    Osal_MemSet(&TempMeasurement, 0 , sizeof(TempMeasurement)); 
    ...
    */
    ...
    Osal_MemCpy(&healthThermometerCollectorContext.TempMeasurementValue, &TempMeasurement, sizeof(TempMeasurement));
...
void HT_Collector_Intermediate_Temperature_Notification_CB(uint16_t attr_handle, uint8_t data_length,uint8_t * value)
{
  ...
  if (attr_handle == healthThermometerCollectorContext.IntermediateTempCharValHandle)
  {
    ...
    */
    ...
    Osal_MemCpy(&healthThermometerCollectorContext.IntermediateTempValue, &TempMeasurement, sizeof(TempMeasurement));
  }
