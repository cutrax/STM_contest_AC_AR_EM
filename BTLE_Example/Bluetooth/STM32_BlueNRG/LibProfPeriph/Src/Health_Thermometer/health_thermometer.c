                   ...
                   BLE_CALLBACK_FUNCTION_TYPE applcb)
{
  ...
  Osal_MemSet(&thermometer,0,sizeof(thermometer));
  ...
  Osal_MemSet(&thermometer.HTtoBLEInf,0,sizeof(thermometer.HTtoBLEInf));
...
tBleStatus HT_Send_Temperature_Measurement(tTempMeasurementVal tempMeasurementVal)
{
  ...
  {
    Osal_MemSet(charval,0x00,TEMPERATURE_MEASUREMENT_MAX_LEN);
...
static void HTProfile_Attribute_Modified_CB(uint16_t handle, uint8_t data_length, uint8_t *att_data)
{
  ...
  Osal_MemCpy((void *) &attValue, (void *) att_data,attValLen); 
  ...
  case EVT_VENDOR:
    {
      ...
      case EVT_BLUE_GATT_WRITE_PERMIT_REQ:
        { 
          ...
          Osal_MemCpy((void *) &attValue, (void *) write_perm_req->data, attValLen); 
