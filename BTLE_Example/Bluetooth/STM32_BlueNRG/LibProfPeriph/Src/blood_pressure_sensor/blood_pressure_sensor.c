		    ...
		    BLE_CALLBACK_FUNCTION_TYPE BPScb) 
{
  ...
  Osal_MemSet(&bloodPressureSensor,0,sizeof(bloodPressureSensor));
  ...
  Osal_MemSet(&bloodPressureSensor.BPStoBLEInf,0,sizeof(bloodPressureSensor.BPStoBLEInf));
...
tBleStatus BPS_Send_Blood_Pressure_Measurement(tBPMValue bpmval)
{
  ...
  {
    Osal_MemSet(charval,0x00,MAX_BPM_CHAR_VAL_LEN);
