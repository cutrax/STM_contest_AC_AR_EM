...
tBleStatus ANC_Client_Init(BLE_CALLBACK_FUNCTION_TYPE applcb)
{
  ...
  Osal_MemSet(&alertNotificationClient,0,sizeof(alertNotificationClient));
  ...
  Osal_MemSet(&alertNotificationClient.ANCtoBLEInf,0,sizeof(alertNotificationClient.ANCtoBLEInf));
