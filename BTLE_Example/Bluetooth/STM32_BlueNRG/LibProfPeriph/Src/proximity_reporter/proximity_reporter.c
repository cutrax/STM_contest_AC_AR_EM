				  ...
				  BLE_CALLBACK_FUNCTION_TYPE profileCallbackFunc)
{
  ...
  Osal_MemSet ( &proximityReporter, 0, sizeof(tProximityReporterContext) );
  ...
  Osal_MemSet ( &proximityReporter.PRtoBLEInf, 0, sizeof(tProfileInterfaceContext) );
...
/* 	  } */
      ...
      case PROXIMITY_REPORTER_STATE_FAST_DISCOVERABLE_DO_START:
	{
	  ...
	  localName[0] = 0x08;
	  Osal_MemCpy ((void *)(localName+1), (void *)"PR", 0x02 );
